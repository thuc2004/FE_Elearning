  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <form onSubmit={handleSubmit} className='w-[500px] border px-2 py-5 rounded shadow-md flex flex-col gap-[12px]'>
        ...
        <div className="mt-4 bg-gray-200 border border-gray-300 rounded p-5 w-1/2 mx-auto"> {/* Giới hạn chiều rộng khung và căn giữa */}
  <label htmlFor="file-upload" className="cursor-pointer block text-center"> {/* Label có thể nhấn */}
    <Input
      id="file-upload"
      type="file"
    ...
    <span className="block text-center text-gray-700 font-semibold">
      {selectedFile ? selectedFile.name : (
        <>
          Chọn file chứng chỉ
          <div className="text-center text-gray-500 font-normal mt-1"> {/* Đặt khoảng cách giữa hai dòng */}
